...
include::authorization/web.adoc[leveloffset=+1]

include::authentication/logout.adoc[leveloffset=+1]
...
include::authentication/inmemory.adoc[leveloffset=+1]

include::authentication/jdbc.adoc[leveloffset=+1]
...
include::authentication/authenticationprovider.adoc[leveloffset=+1]
